...
def getArgs():
    ...
    parser.add_argument('-data_dir_cats_vs_control',
                        default='../cats_vs_control',
                        required=False,
                        help='directory to load data for training, validating and testing.')

    parser.add_argument('-data_dir_dogs_vs_control',
                        default='../dogs_vs_control/',
                        required=False,
    ...
    parser.add_argument('-num_control',
                        default=59664,
                        required=False,
                        help='number of numNucleotide data points, used to calculate the positive weight for the loss function.')
...
def dataPreprocess(batch_size, data_dir, seed, opMode, normalizeDataset):
    ...
    # generated by shuangyan
    # mean_control_vs_heme = [0.7022, 0.5750, 0.7241]
    # std_control_vs_heme = [0.1666, 0.1282, 0.1813]
    # generated by me
    mean_cats_vs_dogs = [0.6008, 0.4180, 0.6341]
    std_cats_vs_dogs = [0.2367, 0.1869, 0.2585]

    # generated by shuangyan
    # mean_control_vs_nucleotide = [0.4677, 0.2245, 0.5148]
    # std_control_vs_nucleotide = [0.3411, 0.3041, 0.3674]
    # generated by me
...
from argumentParser import getArgs
from helper import calc_metrics
...
def test_inference(model, dataloader, device):
    """
    funtion to inference the model on test data
    """
